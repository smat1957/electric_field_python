...
\begin{center}
\includegraphics[scale=0.5]{./figure/experiment.eps}
\end{center}
...
%
  \begin{thebibliography}{99}
    \bibitem{1} コンピュータによる熱移動と流れの数値解析, スハス V. パタンカー, , 森北出版株式会社, 1985
    \bibitem{2} Fortran77による伝熱解析プログラム,中村博, ,サイエンス社,1989
  \end{thebibliography}
